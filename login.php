...
<body background-color="#e0ffcd">
	...
	<div class="limiter">
		<div class="container-login100" background-color="#e0ffcd">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="images/img-01.png" alt="IMG">
				</div>

				<form class="login100-form validate-form" action="login_procesa.php" method="POST">
					...
					<div class="wrap-input100 validate-input" data-validate = "Se requiere contraseña">
						<input class="input100" type="password" id="contraseña" name="pass" placeholder="Contraseña">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
