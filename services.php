		...
		<div class="container">
			...
			<div class="service-grids">
				...
				<div class="col-md-4 service-grid">
					...
					<img src="images/lifthing pestañas.jpg" alt=" " class="img-responsive" />

					<h4> Lifthing de pestañas</h4>
		...
		<div class="container">	
			...
			<div class="service-grids">	
				...
				<div class="col-md-4 service-grid">
					...
					<p>Es una técnica cuya finalidad es la de activar 

						el riego sanguíneo y linfático favoreciendo 
				...
				<div class="col-md-4 service-grid">
					...
					<p>Antigua técnica de masaje oriental, activa los chakras energéticos

						las piedras empleadas son de origen volcánico
				   ...
				   <article style="position: absolute; width: 100%; opacity: 0;"> 
					...
					<div class="banner-wrap">
						...
						<div class="service1-info">
							...
							<p>Temporalmente por cuestiones de público conocimiento en la pandemia 

								Covid - 19, están suspendidas las actividades grupales</p>
						...
						<div class="banner-wrap">
							...
							<div class="service1-info">
								...
								<p> Se hace obligatorio el uso de mascarilla dentro del Spa de todo el personal y de los clientes·
									...
									Se realizarán las revisiones de temperatura en el ingreso al Spa·

									Se realiza la desinfección de superficies obligatoria por parte del personal después de cada visita</p>
				...
				<div class="col-md-6 servc-grid">
					...
					<div class="col-xs-9 servc-grid-left">
						...
						<p>Durante tu estadia nos ocupamos de que reciban el mejor tratamiento 
							...
							para ese día tan especial, belleza de manos y pies, masajes y más Servicios

							disponibles para ti en nuestro Spa, para que te sientas bellízima en tu boda.
			...
			<div class="servc-grids">
				...
				<div class="col-md-6 servc-grid">
					...
					<div class="col-xs-9 servc-grid-left">
						...
						<p>Regalate un día completo en nuestro Spa, probá los mejores tratamientos

							salí renovada junto a tu pareja</p>
				...
				<div class="col-md-6 servc-grid">
					...
					<div class="col-xs-9 servc-grid-left">
						...
						<p>Nuestro compromiso es no contaminar con agentes abrasivos el medio ambiente,
							...
							para preservar nuestro hábitat y promover el bienestar general
...
<div class="container">				 	
 ...
 if(!isset($USER)){echo "<li><a href='login.php'>Ingresa</a></li>";} 
